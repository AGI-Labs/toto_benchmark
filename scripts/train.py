...
@hydra.main(config_path="../toto_benchmark/conf", config_name="train_bc")
def main(cfg : DictConfig) -> None:
    ...
    try:
        print(f"current hydra directory: {hydra.utils.get_original_cwd()}")
        with open(os.path.join(cfg.data.pickle_fn), 'rb') as f:
            data = pickle.load(f)
    except:
