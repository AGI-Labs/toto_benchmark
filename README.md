...
- A zip file for lauching `toto_benchmark/scripts/eval_agent.py` for your agent. Your code folder should contain `eval_agent.py` and any other files needed to launch your agent. Here is an example command to zip your code folder:
  ```
